...
func (m *UserReference) GetToken() string {
	if m != nil {
		return m.Token
	}
	return ""
...
func (m *NameUpdateRequest) GetToken() string {
	if m != nil {
		return m.Token
	}
	return ""
...
func (m *SubProfileRequest) GetToken() string {
	if m != nil {
		return m.Token
	}
	return ""
...
func (m *PasswordChangeMsg) GetToken() string {
	if m != nil {
		return m.Token
	}
	return ""
...
func (m *EmailChangeMsg) GetToken() string {
	if m != nil {
		return m.Token
	}
	return ""
...
var fileDescriptor_23188efcd8e5ff27 = []byte{
	...
	,
}
...
type UserManagementApiClient interface {
	...
	CheckRefreshToken(ctx context.Context, in *UserReference, opts ...grpc.CallOption) (*Status, error)
	TokenRefreshed(ctx context.Context, in *UserReference, opts ...grpc.CallOption) (*Status, error)
	// User properties:
...
func (c *userManagementApiClient) CheckRefreshToken(ctx context.Context, in *UserReference, opts ...grpc.CallOption) (*Status, error) {
	out := new(Status)
	err := c.cc.Invoke(ctx, "/influenzanet.user_management_api.UserManagementApi/CheckRefreshToken", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *userManagementApiClient) TokenRefreshed(ctx context.Context, in *UserReference, opts ...grpc.CallOption) (*Status, error) {
	out := new(Status)
...
type UserManagementApiServer interface {
	...
	CheckRefreshToken(context.Context, *UserReference) (*Status, error)
	TokenRefreshed(context.Context, *UserReference) (*Status, error)
	// User properties:
...
func _UserManagementApi_CheckRefreshToken_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/influenzanet.user_management_api.UserManagementApi/CheckRefreshToken",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(UserManagementApiServer).CheckRefreshToken(ctx, req.(*UserReference))
	}
	return interceptor(ctx, in, info, handler)
}
