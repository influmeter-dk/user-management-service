...
// Source: ../messaging-service/pkg/api/manage/message-service.pb.go

// Package mock_manage is a generated GoMock package.
package mock_manage
...
import (
	...
	manage "github.com/influenzanet/messaging-service/pkg/api/manage"
...
func (m *MockMessagingServiceApiClient) Status(ctx context.Context, in *empty.Empty, opts ...grpc.CallOption) (*manage.ServiceStatus, error) {
	m.ctrl.T.Helper()
	...
	ret0, _ := ret[0].(*manage.ServiceStatus)
	ret1, _ := ret[1].(error)
	return ret0, ret1
}
...
func (m *MockMessagingServiceApiClient) SendInstantEmail(ctx context.Context, in *manage.SendEmailReq, opts ...grpc.CallOption) (*manage.ServiceStatus, error) {
	m.ctrl.T.Helper()
	varargs := []interface{}{ctx, in}
	for _, a := range opts {
		varargs = append(varargs, a)
...
// Status mocks base method
func (m *MockMessagingServiceApiServer) Status(arg0 context.Context, arg1 *empty.Empty) (*manage.ServiceStatus, error) {
	m.ctrl.T.Helper()
...
// SendInstantEmail mocks base method
func (m *MockMessagingServiceApiServer) SendInstantEmail(arg0 context.Context, arg1 *manage.SendEmailReq) (*manage.ServiceStatus, error) {
	m.ctrl.T.Helper()
